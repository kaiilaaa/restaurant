  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav ms-auto">
        ...
        <li class="nav-item"><a class="nav-link text-warning fw-bold" href="manage.php">Manage</a></li>
        <li class="nav-item"><a class="nav-link" href="manage_menu.php">Manage Categories</a></li>
      </ul>
    </div>
  </div>
</nav>
...
<div class="container py-5 text-center">
    ...
    <h2 class="menu-header h4 mb-5">Menu List</h2>
